...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <table width="649" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
      <tr>
        <td width="645" height="47" align="center" bgcolor="#FFFFFF"><label>
         ${resObj.subject}
        </label></td>
      </tr>
      <tr>
...
<embed type=application/x-oleobject codebase=http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab#Version=5,1,52,701 flename=mp src=${resObj.url}" width=356 height=320></embed>　 
</object>        </td>
      </tr>
    </table>
