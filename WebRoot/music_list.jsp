...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	&nbsp;&nbsp;<a href="musictoadd_admin">我要上传音乐
    </a><br />
...
<c:forEach items="${pi.list}" var="obj" varStatus="con">
  <tr class="tdbg">
    ...
    <td bgcolor="#FFFFFF"><div align="center"><a href="<%=request.getContextPath() %>/musicdelete_admin?par.id=${obj.id }" onClick="return confirm('确定删除吗？')">删除</a>
    <a href="<%=request.getContextPath() %>/music_play?mvo.id=${obj.id }" >试听</a>
...
<div align="center">
	<jsp:include page="/pageinfo.jsp">
									<jsp:param value="musiclist_admin" name="path"/>
  </jsp:include>
</div>
    </td>
  </tr>
