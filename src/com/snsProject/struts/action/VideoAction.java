...
import com.snsProject.dao.impl.VideoDAOImpl;
...
public class VideoAction extends SuperAction{
	...
	public IVideoDao getmDao() {
			return mDao;
		}

		public void setmDao(IVideoDao mDao) {
			this.mDao = mDao;
		}
